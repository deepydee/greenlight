...
import (
	...
	"flag"
	"fmt"
	"github.com/deepydee/greenlight/src/internal/data"
	"github.com/deepydee/greenlight/src/internal/jsonlog"
	"github.com/deepydee/greenlight/src/internal/mailer"
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", dsnDefault, "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.host, "smtp-host", "mailpit", "SMTP host")
	...
	flag.StringVar(&cfg.smtp.password, "smtp-password", "secret", "SMTP password")
